...
public class MobileUserResourceIT {
    ...
    public void createMobileUser() throws Exception {
        ...
        assertThat(testMobileUser.getUserId()).isEqualTo(DEFAULT_USER_ID);
        assertThat(testMobileUser.getStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testMobileUser.getIcon()).isEqualTo(DEFAULT_ICON);
        assertThat(testMobileUser.getIconContentType()).isEqualTo(DEFAULT_ICON_CONTENT_TYPE);
        assertThat(testMobileUser.getUsername()).isEqualTo(DEFAULT_USERNAME);
    }
    ...
    public void updateMobileUser() throws Exception {
        ...
        assertThat(testMobileUser.getUserId()).isEqualTo(UPDATED_USER_ID);
        assertThat(testMobileUser.getStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testMobileUser.getIcon()).isEqualTo(UPDATED_ICON);
        assertThat(testMobileUser.getIconContentType()).isEqualTo(UPDATED_ICON_CONTENT_TYPE);
        assertThat(testMobileUser.getUsername()).isEqualTo(UPDATED_USERNAME);
    }
