...
/**
 * REST controller for managing {@link com.universaldoctor.igive2.domain.Answer}.
 */
@RestController
@RequestMapping("/api")
public class AnswerResource {
    ...
    public AnswerResource(AnswerService answerService,FormAnswersService formAnswersService) {
