...
/**
 * REST controller for managing {@link com.universaldoctor.igive2.domain.Participant}.
 */
@RestController
@RequestMapping("/api")
public class ParticipantResource {
    ...
    public ParticipantResource(ParticipantService participantService,MobileUserService mobileUserService) {
